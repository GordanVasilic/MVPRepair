...
async function testFixedAdminQuery() {
  console.log('🔍 Testira popravljen AdminIssues query...')
  ...
  try {
    ...
    console.log('📊 Popravljen query rezultat:')
    ...
    // 3. Alternativno - testiraj kroz buildings sa popravkom
    console.log('\n🔄 Testiram alternativni query kroz buildings (popravljen)...')
